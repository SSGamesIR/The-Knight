...
public class playerendwalk : MonoBehaviour
{

    private Animator anim;
    private CharacterController charController;
    private CollisionFlags collisinFlags = CollisionFlags.None;
    ...
    bool IsGrounded()
    {
        return collisinFlags == CollisionFlags.CollidedBelow ? true : false;
    }
    ...
    void CheckIfFinishedMovement()
    {
        ...
        else
        {
            ...
            collisinFlags = charController.Move(player_Move);
        }
    }
